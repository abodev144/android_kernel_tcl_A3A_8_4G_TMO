...
/*[BUGFIX]-Mod-BEGIN by TCTSZ.(gaoxiang.zou@tcl.com)  12/29/2016*/
//task 6104316
///*/sys/devices/virtual/deviceinfo/device_info/eMMC*/
///*/sys/class/deviceinfo/device_info/eMMC*/
extern struct device* get_deviceinfo_dev(void);
static u8 *emmc_spt_tab[][4] = {
    /*:::*/
    {"150100474536424D42", "KMGE6001BM_B421",		"Samsung",	"16G+3G"},
    {"150100514536334D42", "KMQE60013M_B318",		"Samsung",	"16G+2G"},//for a3a4g
    {"700100464D41434541", "16EMCP16_EL3DTB28",     "Kingston", "16G+2G"},/*defect6633213 for a3a84gtmo memory size check gaoxiang.zou@tcl.com*/
    {"150100464536324D42", "KMFE60012M_B214",		"Samsung",	"16G+1G"},//for a3a84g
    {"700100454841454538", "16EMCP08_NL3DT527",		"Kingston",	"16G+1G"},//for a3a84g
    {"150100475836424D42", "KMGX6001BM_B514",		"Samsung",	"32G+3G"},
    {"150100524836344142", "KMRH60014A_B614",		"Samsung",	"64G+4G"},
    {"90014A484247346132", "H9TQ26ADFTBCUR_KUM",		"Hynix",	"32G+3G"},
    {"90014A484347386134", "H9TQ52ACLTMCUR_KUM",		"Hynix",	"64G+4G"},
    {"E9010F413932534B42", "IMM16GA92SKB-WT",		"Icmax",	"16G+1G"}, //for a3a84g
    {"8801034E4361726420", "NCEMASKG-16G",		"Longsys",	"16G+1G"}, //for a3a84g
    {"880103443939313647", "NCEMAD99-16G",		"Longsys",	"16G+1G"}, //for a3a84g
    {"450100444634303332", "SDINADF4-32G-D",		"Sandisk",	"32G+3G"}, //for a3a84g
	{NULL},
};
...
static const DEVICE_ATTR(eMMC, S_IWUSR | S_IRUGO, emmc_id_show, emmc_id_store);
