...
#endif
//modify begin by yusen.ke.sz for bringup 3rd lcm on 20181011
extern LCM_DRIVER otm1287a_pb_dsi_lcm_drv;
//modify begin by yusen.ke.sz for bringup 3rd lcm on 20181011
//add begin by yusen.ke.sz for bringup 4th lcm on 20181105
extern LCM_DRIVER otm1287a_tdt_dsi_lcm_drv;
//add end by yusen.ke.sz for bringup 4th lcm on 20181105
LCM_DRIVER *lcm_driver_list[] = {
//modify begin by yusen.ke.sz for bringup 3rd lcm on 20181011
#if defined(OTM1287A_PB_VIDEO)
	&otm1287a_pb_dsi_lcm_drv,
#endif
//modify begin by yusen.ke.sz for bringup 3rd lcm on 20181011
//add begin by yusen.ke.sz for bringup 4th lcm on 20181105
#if defined(OTM1287A_TDT_VIDEO)
	&otm1287a_tdt_dsi_lcm_drv,
#endif
//add end by yusen.ke.sz for bringup 4th lcm on 20181105
#if defined(RM68200_PB_VIDEO)
	&rm68200_pb_dsi_lcm_drv,
#endif
#if defined(RM68200_TDT_VIDEO)
    &rm68200_tdt_dsi_lcm_drv,
#endif
