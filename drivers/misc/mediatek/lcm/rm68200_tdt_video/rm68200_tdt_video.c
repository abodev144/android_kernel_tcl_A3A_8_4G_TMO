...
static const struct of_device_id lcm_platform_of_match[] = {
	{
	 .compatible = "rm,rm68200_tdt_dsi_vdo",
	 .data = 0,
	 }, {
	     /* sentinel */
	     }
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch = 40; //modify by RF required,ke.huang 2018.5.22
	...
	params->dsi.PLL_CLOCK = 210;//modify by yusen.ke.sz@tcl.com at 20180717 for fix cts test fail 
}
...
{
	printk("enter rm68200 tdt suspend\n");
...
{
	printk("enter rm68200 tdt resume\n");
	lcm_init_lcm();
}
...
LCM_DRIVER rm68200_tdt_dsi_lcm_drv = {
	.name = "rm68200_tdt_dsi",
