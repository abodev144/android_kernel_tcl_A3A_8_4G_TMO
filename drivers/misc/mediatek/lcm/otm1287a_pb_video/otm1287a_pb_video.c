...
static const struct of_device_id lcm_platform_of_match[] = {
	{
	 .compatible = "rm,otm1287a_pb_dsi_vdo",
	 .data = 0,
	 }, {
	     /* sentinel */
	     }
...
{
	printk("enter otm1287a pb suspend\n");
...
{
	printk("enter otm1287a pb resume\n");
	lcm_init_lcm();
}
...
LCM_DRIVER otm1287a_pb_dsi_lcm_drv = {
	.name = "otm1287a_pb_dsi",
