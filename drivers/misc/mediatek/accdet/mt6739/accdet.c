...
static inline void accdet_init(void)
{
    ...
    //Modified by ke.huang for Defect 6294182 on 2018/05/08 begin
    pmic_pwrap_write(AUDENC_ANA_CON9, pmic_pwrap_read(AUDENC_ANA_CON9)|(headset_dts_data.mic_bias_vol<<4));
    //Modified by ke.huang for Defect 6294182 on 2018/05/08 end
