...
#endif
#if defined(R_SUN_GC5025A_MIPI_RAW)
	{
		SENSOR_DRVNAME_REAR_SUNRISE_GC5025A_MIPI_RAW,
		{
			{PDN, Vol_Low, 5},
			{RST, Vol_Low, 5},
			{DOVDD, Vol_1800, 5},
...
#endif
#if defined(R_CXT_GC5025A_MIPI_RAW)
	{
		SENSOR_DRVNAME_REAR_CXT_GC5025A_MIPI_RAW,
		{
			{PDN, Vol_Low, 5},
			{RST, Vol_Low, 5},
			{DOVDD, Vol_1800, 5},
...
#endif
#if defined(F_EWE_GC5025A_MIPI_RAW)
	{
		SENSOR_DRVNAME_FRONT_EWELLY_GC5025A_MIPI_RAW,
		{
			{PDN, Vol_Low, 5},
			{RST, Vol_Low, 5},
			{DOVDD, Vol_1800, 5},
			{DVDD, Vol_1200, 5},
			{AVDD, Vol_2800, 5},
			{SensorMCLK1, Vol_High, 5},
			{PDN, Vol_High, 5},
			{RST, Vol_High, 5}
		},
	},
#endif
#if defined(F_SUN_HI556_MIPI_RAW)
	{
		SENSOR_DRVNAME_FRONT_SUNRISE_HI556_MIPI_RAW,
		{
			{PDN, Vol_Low, 5},
			{RST, Vol_Low, 5},
			{DOVDD, Vol_1800, 5},			
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_off_sequence[] = {
/*[bugfix]-add-begin,zhongzhu.peng@tcl.com,6748621 on 20180810*/
//modify for the power off sequence
#if defined(R_SUN_GC5025A_MIPI_RAW)
	{
		SENSOR_DRVNAME_REAR_SUNRISE_GC5025A_MIPI_RAW,
		{
...
#endif
/*[bugfix]-add-end,zhongzhu.peng@tcl.com,6748621 on 20180810*/
#if defined(F_SUN_HI556_MIPI_RAW)
	{
		SENSOR_DRVNAME_FRONT_SUNRISE_HI556_MIPI_RAW,
		{
