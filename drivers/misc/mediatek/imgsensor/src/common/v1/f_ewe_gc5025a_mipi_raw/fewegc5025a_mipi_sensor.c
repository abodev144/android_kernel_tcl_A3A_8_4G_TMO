...
#include "fewegc5025a_mipi_sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "front_ewelly_GC5025A_camera_sensor"
...
#define RG_TYPICAL    		659
#define BG_TYPICAL			602
...
//	unsigned int gpio_id;
    pr_err("front ewelly gc5025a get_imgsensor_id\n");
...
UINT32 FRONT_EWELLY_GC5025A_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
