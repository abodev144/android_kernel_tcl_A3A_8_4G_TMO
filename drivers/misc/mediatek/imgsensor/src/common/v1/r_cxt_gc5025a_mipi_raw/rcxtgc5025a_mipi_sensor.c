...
#include "rcxtgc5025a_mipi_sensor.h"

#include "../imgsensor_proc.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "rear_cxt_GC5025A_camera_sensor"
...
static kal_bool GC5025ADuringTestPattern = KAL_FALSE;
...
#define RG_TYPICAL    		1305
#define BG_TYPICAL			1154
...
//				gc5025a_otp_info.golden_bg = (((golden[2]<<8)&0xff00)|golden[3]) > 0 ? (((golden[2]<<8)&0xff00)|golden[3]) : BG_TYPICAL;
				gc5025a_otp_info.golden_rg =  RG_TYPICAL;
				gc5025a_otp_info.golden_bg =  BG_TYPICAL;
	...
	snprintf(mtk_main_otp_info, sizeof(mtk_main_otp_info),"Rear cxt_gc5025a:\nyear:%d, month:%d, day:%d\nmodule_id:%d, les_id:%d\nr/g:%d, b/g:%d\ngolden_r/g:%d, golden_b/g:%d", gc5025a_otp_info.year, gc5025a_otp_info.month, gc5025a_otp_info.day, gc5025a_otp_info.module_id, gc5025a_otp_info.lens_id, gc5025a_otp_info.rg_gain, gc5025a_otp_info.bg_gain, gc5025a_otp_info.golden_rg, gc5025a_otp_info.golden_bg);
#endif
#endif
...
*
*************************************************************************/
extern	unsigned int get_camera_id0(void);
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
	unsigned int gpio_id;
    pr_err("rear cxt gc5025a get_imgsensor_id\n");
	gpio_id = get_camera_id0();
	pr_err("sunrise gc5025a gpio id = %d\n",gpio_id);
	if(gpio_id != 0)
	{
...
UINT32 REAR_CXT_GC5025A_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
