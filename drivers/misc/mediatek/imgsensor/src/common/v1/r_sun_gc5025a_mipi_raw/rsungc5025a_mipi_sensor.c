...
#include "rsungc5025a_mipi_sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "rear_sunrise_GC5025A_camera_sensor"
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    pr_err("rear sunrise gc5025a get_imgsensor_id\n");
...
UINT32 REAR_SUNRISE_GC5025A_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
